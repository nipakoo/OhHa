...
public class MuodonLuojaTest {
    ...
    public void nelioMuodostuuOikein() {
        ...
        assertEquals(ruudut.equals(muodonLuoja.luoNelio(0)), true);
    }
    ...
    public void suorakulmioMuodostuuOikein() {
        ...
        assertEquals(ruudut.equals(muodonLuoja.luoSuorakulmio(6)), true);
    }
    ...
    public void mutkaMuodostuuOikein() {
        ...
        assertEquals(ruudut.equals(muodonLuoja.luoMutka(4)), true);
    }
    ...
    public void LMuodostuuOikein() {
        ...
        assertEquals(ruudut.equals(muodonLuoja.luoL(7)), true);
    }
}
