...
public class MutkanKaantaja extends PalikanKaantaja {
    ...
    public void kaannaMutka() {
        ...
        siirraRuutua(0, mistaAsennosta * 2, mistaAsennosta * 0);
        siirraRuutua(1, mistaAsennosta * 1, mistaAsennosta * 1);
        siirraRuutua(2, mistaAsennosta * 0, mistaAsennosta * 0);
        siirraRuutua(3, mistaAsennosta * -1, mistaAsennosta * 1);
    }
}
